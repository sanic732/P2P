...
scope: Установка P2P 8.4.7-C и переход с v8C.2. Не содержит информации о переходе с более ранних версий.
tags: docs, install, upgrade, v8c3
---

# P2P 8.4.7-C — РУКОВОДСТВО ПО УСТАНОВКЕ
...
> (+`[41] /p2p-download`, +`[42] Создать Agent Skill`), а `/p2p` стал диспетчером:
> вызов без аргументов → меню, `/p2p <задача>` → SIR Scanner → Tier → Contract Builder.
