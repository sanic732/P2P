...
**Упражнение:**
Открой главный файл `!!core_v8C.md` и пролистай меню (42 пункта). Напиши какой пункт привлёк внимание.
...
A: 21 тип системных ошибок Claude (G1-G22, G5 не занят). G6=stop-token confusion, G7=temperature+thinking conflict, G8=budget_tokens deprecated. См. `!!db_v8C.md` раздел 4.
