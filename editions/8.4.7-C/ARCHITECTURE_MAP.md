...
```
/p2p (без аргументов)|старт|full ui menu → STARTUP_LOGO → FULL menu [1-42] + ✈ PILOT toggle
/p2p <задача> → ДИСПЕТЧЕР: SIR Scanner → Tier → Contract Builder (меню НЕ показывается)
