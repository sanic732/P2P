...
**Version:** 8.4.6-N · **Token budget:** MINIMAL ~60K · STANDARD ~120K (реком.) · FULL ~200K
...
A vendor-agnostic universal preloader. `!!core_v8N.md` rewrites syntax on the fly per host (JSON for GPT, native reasoning for DeepSeek, strict Markdown for GLM).

## What's new
.3 generation: same 6 ON-DEMAND modules and VERSION_COMPAT; live specs 2026-06-27.
