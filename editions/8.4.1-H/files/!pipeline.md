...
INTENT_5D:
  ...
  IF D4 не указан → AUTO-ORCHESTRATION в !!core_v8H.md.
...
CONTRACT_BUILDER:
  PHILOSOPHY:
    ...
    Цель: успех с первой попытки. Иначе → Feedback Loop (!!db_v8H.md).
  ...
  PHASE 2 — CORE:
    ...
    STEP 6: Conversation History / Memory
      ...
      Source: !memory.md session state или явные заявления пользователя.
  ...
  BONUS STEPS:
    ...
    STEP 11: Post-Deployment Iteration
      ...
      2. CLASSIFY: Тип ошибки (A-P из !!db_v8H.md).
...
VERSION_METADATA:
  SYSTEM:       P2P v8H.3 Normal · Pipeline
  PREDECESSOR:  !pipeline.md v7N.1
  CONTENT:      5D Intent Analysis, 11-Step Contract Builder, Templates A-M (13)
  NEW_IN_v8H1:  Template M (Karpathy Mode), обновлённый Step 8 (все 8 моделей)
  COMPATIBLE:   !!core_v8H.md | !!db_v8H.md | !agents.md | !toolkit.md
