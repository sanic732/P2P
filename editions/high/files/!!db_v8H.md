...
API_STRINGS:
  ...
  CLAUDE:
    claude-fable-5                     ← v8H рекомендован (Tier 3-4, #1 Agent/WebDev; Safety Nanny ~5%→Opus 4.8)
    claude-opus-4-8                    ← v8H рекомендован (Tier 3-4, coding #1)
    claude-opus-4-7                    ← legacy флагман (Tier 3-4)
    claude-sonnet-4-6                  ← v8H рекомендован (Tier 1-3)
...
// ═══════════════════════════════════════════════════════
// [v8H.3] GROK HEAVY FAILURE MODES (Type B/H/T/X/V) — из донора 8G.1
