...
```
  ...
  SOURCE: vendors/tier2.md (Grok 4.5/4.3 + G14 safe-params) ; live_specs KNOWN_ISSUES[Type H / G14].

VERSION_METADATA:
  SYSTEM:       P2P v8N.3 Normal · Pipeline
  PREDECESSOR:  !pipeline.md v7N.1
  CONTENT:      5D Intent Analysis, 11-Step Contract Builder, Templates A-M (13)
  NEW_IN_v8N1:  Template M (Karpathy Mode), обновлённый Step 8 (все 8 моделей)
