---
id: skills_generator_v8N
version: v8N.3
type: ON_DEMAND
priority: 3
edition: NORMAL
menu_item: 32
depends_on: "!!core_v8N.md, _preloader.md"
trigger: "skill|скилл|agent skill|create skill|создай скилл|SKILL.md|навык агента"
tags: agent-skills, skill-md, generator, agentskills-io, progressive-disclosure, v8n3
...
// ПРИМ: это ГЕНЕРАЦИЯ артефакта, НЕ установка плагина. По образцу offer+generator (в High — !grok_heavy.md; в N этого модуля нет).
// ═══════════════════════════════════════════════════════
...
VERSION_METADATA:
  SYSTEM:      P2P v8N.3 · !skills.md (Agent Skills generator)
  STANDARD:    agentskills.io (specification + best-practices + optimizing-descriptions)
  COMPATIBLE:  !!core_v8N.md | _preloader.md | _index.md
  COMMAND:     /p2p-skill [задача]
// EOF_MARKER_SKILLS_V8N_VALIDATED
