...
### Note
Внешний слой Lite тянется из Gist. Обновление гистов в этот выпуск **не входит** —
нативная часть приедет при пересборке поставки, внешняя дельта после обновления Gist.
