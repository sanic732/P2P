...
// ═══════════════════════════════════════════════════════
## Activation & Inference Debugging — prompt-side only
// Источник: КАРТА_ИНТЕГРАЦИИ §3.4 (в 8N debug консолидирован в !toolkit, не !debug). Append-only.
// ═══════════════════════════════════════════════════════

ACTIVATION_DEBUG:  // РЕФЕРЕНС. Реальный activation steering требует доступа к весам.
...
FILE_META:
               Prompt Enhance, Tech Combinator, Activation Debug
