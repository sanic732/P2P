...
## ★ CRITICAL DEADLINES (from 2026-09-10)

| Deadline | Что происходит | Замена / действие | Priority |
|----------|------------|-------------|----------|
| ~~2026-09-09~~ | ~~GLM-5.3-Flash launch promo (−50%)~~ | ИСТЁК 09.09 — цена $0.15/$0.03/$0.50 | ✅ исполнено |
| **2026-09-13** [T-3] | Claude Code: промо +50% к недельным лимитам заканчивается | планировать нагрузку заранее | 🟡 limits |
| **2026-09-14** [T-4] | Claude Code: постоянные +25% к недельным лимитам (Pro/Max/Team/seat Enterprise) — [S], источник только запись 29.08 в соцсети | по словам Anthropic это −17% против сегодняшнего; статья help-центра 15910845 в пересказе говорит, что лимиты «вернутся к стандартным», без +25% — тело статьи не читалось | 🟡 limits |
| **2026-09-20** [T-10] | GLM-5.3-Flash бесплатен в ZCode 23:00–09:00 UTC+8 — кампания заканчивается | вне ZCode в это окно квота удваивается | 🟡 pricing |
| **2026-09-29** [T-19] | `claude-sonnet-4-5` — самая ранняя дата снятия | → `claude-sonnet-5` | 🟡 retirement |
| **2026-10-10** [T-30] | Alibaba снимает историческую линейку qwen (шесть уведомлений, полный список id не прочитан) | → линейка 3.8 | 🟡 retirement |
| **2026-10-15** [T-35] | `claude-haiku-4-5` — самая ранняя дата снятия | → следующий Haiku | 🟡 retirement |
| **2026-10-19** [T-39] | Microsoft Foundry снимает `claude-haiku-4-5` / `sonnet-4-5` / `opus-4-5` | → актуальные id | 🟡 retirement |
| **2026-11-21** [T-72] | GPT-5.6 Sol: промо-цена $4/$0.40/$20 «не раньше» этой даты | пол, а не жёсткий конец | 🟡 pricing |
| **2026-12-31** [T-112] | Gemini Flash-линия (3.6/3.7/3.8): вводная цена заканчивается | $0.75/$3.75 → $1.50/$7.50 с 01.01.2027 | 🟡 pricing |
...
|------|-----|--------------------|--------|
| vendors/_live_manifest.md | Live | При дедлайнах | ✅ v8C.3 |
...
> Активировать: `preloader.md → VERSION_COMPAT → MODULE_X: true`
