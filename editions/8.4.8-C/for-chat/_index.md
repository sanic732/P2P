...
│   ├── !!db_v8C.md            [3] G-errors G1-G22, Templates A-M, 9-step algo
...
│   ├── !skills.md             Генератор Agent Skills (SKILL.md, agentskills.io) — пункт [42]
...
│   └── (Grok 4.6/4.5/4.3 TARGET-данные → vendors/tier3.md; strict JSON контракт → !contract.md GROK_JSON_TARGET)
│
...
│   ├── CREDITS_TECHNIQUES.md  Первоисточники техник релиза 8.4.4 (arXiv + Anthropic)
...
| `verbalized` | !writing.md |
| `positive-framing` | !!db_v8C.md |
| `context-engineering` | !compression.md, !memory.md |
