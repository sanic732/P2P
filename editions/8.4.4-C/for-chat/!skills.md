---
id: skills_generator_v8C
version: v8C.3
type: ON_DEMAND
priority: 3
edition: CLAUDE_NATIVE
depends_on: "!!core_v8C.md, _preloader.md"
trigger: "skill|скилл|agent skill|create skill|создай скилл|SKILL.md|навык агента"
tags: agent-skills, skill-md, generator, agentskills-io, progressive-disclosure, v8c3
...
VERSION_METADATA:
  SYSTEM:      P2P v8C.3 · !skills.md (Agent Skills generator)
  STANDARD:    agentskills.io (specification + best-practices + optimizing-descriptions)
  COMPATIBLE:  !!core_v8C.md | _preloader.md | _index.md
  COMMAND:     /p2p-skill [задача]
// EOF_MARKER_SKILLS_V8C_VALIDATED
