...
- Модель: **Claude Fable 5 / Opus 4.8 / Opus 4.7 / Sonnet 4.6** (pxpipe-чтение — только Fable 5).
...
`/p2p-v8c3:p2p` → должно открыться меню P2P (ASCII-логотип + пункты [1-40]).
...
`pxpipe`, `bb4pda`, `rag-prep`, `rag-grounding`, `rag-router`, `notebook-pack`.
...
| pxpipe (сжатие токенов) | `/p2p-v8c3:p2p-pxpipe` + skill | недоступен (нужны tools) |
