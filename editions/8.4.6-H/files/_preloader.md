...
// ═══════════════════════════════════════════════════════
// P2P — PRELOADER (NATIVE / auto-host, порт механики 8L.3)
...
// Управляет сосуществованием стабильной логики A⊕G (merge 8A.1+8G.1) и новых техник.
...
HOST_PICK_LIST:  // fallback — ручной выбор, если автодетект (БЛОК 0) неуверен
  EMIT: "🌐 Не удалось надёжно определить хост. На какой LLM ты запускаешь P2P v8H?
