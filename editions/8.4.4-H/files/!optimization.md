...
depends_on: "!!core_v8H.md, !!db_v8H.md, !pipeline.md, !metrics.md"
...
// ═══════════════════════════════════════════════════════
// P2P v8H.3 — OPTIMIZATION MODULE (!optimization.md)
...
// Метрика качества берётся из !metrics [v8H.3] Quality Eval (LLM-as-Judge / SelfCheck).
