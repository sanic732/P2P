...
// ═══════════════════════════════════════════════════════
// P2P v8H.3 — RAG MODULE (!rag.md)
// Загружен: добавлен пункт [35] в меню.
// ═══════════════════════════════════════════════════════

// ─── HOST-ADAPTIVE NOTE ───
// Этот модуль аддитивный — не конфликтует с базовой логикой v8H.
...
Аддитивный модуль. При пересечении с [16] DATOS Deep Search / поиском в !!db_v8H:
- база v8H: keyword/semantic search
