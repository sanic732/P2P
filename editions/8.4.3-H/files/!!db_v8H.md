...
API_STRINGS:
  ...
  CLAUDE:
    claude-fable-5                     ← v8H рекомендован (Tier 4, Overall/Text/Vision #1; classifier FP ~5%→Opus 4.8)
    claude-sonnet-5                    ← v8H рекомендован (Tier 2-3, default Free/Pro; near-Opus)
    claude-opus-4-8                    ← v8H рекомендован (Tier 3-4, coding primary)
  ...
  KIMI:
    kimi-k2.6                          ← Стандарт (Swarm 300); kimi-k2.7-code (open-weight); kimi-for-coding-highspeed
