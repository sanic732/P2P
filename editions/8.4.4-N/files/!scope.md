...
ROUTER:
  ...
  ROUTING_LOGIC:
    ...
    2. Получить базовые веса из !!db_v8N.md §QUORUM_WEIGHTS
...
VERSION_METADATA:
  SYSTEM:      P2P v8N.3 Normal · Scope.Helm v1.2
  PREDECESSOR: !scope.md v7N.1
  SECTIONS:    SPLITTER, CAPSULE, ROUTER, ATLAS v2, GUARDIAN
  COMPATIBLE:  !!core_v8N.md | !!db_v8N.md | !memory.md
