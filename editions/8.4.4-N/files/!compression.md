...
// ═══════════════════════════════════════════════════════
// P2P v8N.3 — COMPRESSION MODULE (!compression.md)
...
VERSION_METADATA:
  SYSTEM:      P2P v8N.4 Normal · Compression Module
  TECHNIQUES:  LLMLingua, Gist_Tokens, Verbatim_Deletion, Selective_Summarization, Constrained_Gen, Context_Engineering
  CHANGELOG:   2026-07-18 v8N.4 — +раздел «CONTEXT ENGINEERING (Anthropic framing)»; ссылка из !memory
