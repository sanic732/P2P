...
GEMINI_35_FLASH:
  ...
  strengths:    High-frequency, budget, 1M context (GA default в приложении)

  NOTE: G2 (ZERO XML) применяется так же как Pro.
  NOTE: G13 (Error 13 @100-128K; non-English триггерит) — cap 80K.
...
DEEPSEEK_V4_FLASH:
  ...
  NOTE: G16 — deepseek-chat/reasoner alias → HTTP 404 c 2026-07-24 15:59 UTC (no grace).
...
VERSION_METADATA:
  SYSTEM:      P2P v8N.3 · Vendors Tier 3
