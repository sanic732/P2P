...
scope: P2P v8C.3 entry point — environment detection, USER_CONTEXT, PROJECT_CARD, VERSION_COMPAT (v8C.2/v8C.3/module flags), TRI_MODE_BRIDGE v3, load order. Always loaded first.
...
`[P2P v8C.3 | ENV: {ENV} | Guardian: {ON/OFF}]`
