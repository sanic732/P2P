...
# P2P v8C.3 — LIVE CLAUDE SPECS (vendors/_live_claude.md)
...
```
API:      claude-opus-4-8 (primary complex code; SWE-bench Pro 69.2%) · claude-opus-4-7 · claude-opus-4-6
...
- G6: общий токенизатор Opus 4.7/4.8/Fable 5/Sonnet 5 → +30-42% на англ. прозе (by design; cost-sensitive → пин Opus 4.6)
...
```
Cost-efficient agentic → Sonnet 5 | Complex code / audit → Opus 4.8 (primary)
> 500K + recall        → Opus 4.6 pinned (G8) | Frontier / vision → Fable 5 (Arena #1)
```
