...
| [FAQ_И_ОШИБКИ.md](FAQ_И_ОШИБКИ.md) | частые вопросы + типовые ошибки (префикс команд, Cowork, YAML, pxpipe) | при любой проблеме |
| [AGENTS_GUIDE.md](AGENTS_GUIDE.md) | 8 агентов QUORUM: роли, запуск, паттерны, веса, VETO | работа с `/p2p-quorum` |
| [PXPIPE_GUIDE.md](PXPIPE_GUIDE.md) | оптическое сжатие токенов: теория, замеры, прокси, гейты | Fable 5, экономия токенов |
