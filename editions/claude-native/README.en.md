...
**Version:** 8C.3 · **Token budget:** MINIMAL ~7K · LIGHT ~16K · MEDIUM ~30K · FULL ~59K

## Who it's for
Anyone working in **Claude** (Opus 4.8 / Sonnet 4.6 / Fable 5): Claude Code, Cowork, or Claude.ai Projects.

## What makes it different
The most native edition: XML core, 40-item menu, one-command `/plugin` install, 8 QUORUM agents, 11 slash commands. The **ANON** agent is the security specialist here (a coder elsewhere); Claude Code writes the code.
