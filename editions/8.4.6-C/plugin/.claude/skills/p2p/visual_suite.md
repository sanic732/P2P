...
depends_on: [db.md, templates_library.md]
...
# visual_suite.md — Visual / Video / Audio Suite (v8C.3)
...
| 3 | Apply Template I (Image) or Template V (Video) from templates_library.md |
