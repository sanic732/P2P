...
token_estimate: ~3200
scope: Расширенные техники reasoning для P2P — TTS, Self-Consistency, MCTS, rStar-Math, критические цепочки, Context-Grounding CoT. Загружается по триггеру или MODULE_REASONING=true.
...
**Конфликт 1:** `MODULE_REASONING` + `DEEP_THINK_VALUE_GATE` (v8C.3)
