...
tags: [writing, constraint-prompting, tone, humanization, anti-ai-detector, verbalized]
triggers: [write, написать, текст, статья, article, post, пост, copy, copywriting, humanize, humanized, anti-ai, ai-detector]
---

# !writing.md — Writing Quality Control
...
## §10. CREATIVE DIVERSITY & SELF-CRITIQUE

> On-demand творческие техники. Полные блоки живут здесь; строки-указатели — в `!!db_v8C.md` Раздел 8.
...
**BRUTAL_EDITOR** #DB_TECHNIQUE_BRUTAL_EDITOR (вариант Template L → `!!db_v8C.md` #DB_TEMPLATE_L)
