...
// ═══════════════════════════════════════════════════════
// P2P v8N.3 — SECURITY MODULE (!security.md)
...
Когда: высокий stakes (медицина/право/финансы/факты). Связь: !metrics [v8N.3] Quality Eval.
```
...
VERSION_METADATA:
  SYSTEM:      P2P v8N.3 Normal · Security Module
