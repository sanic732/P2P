...
CLAUDE_SONNET_46:
  ...
  pricing:        $3/$15 per M
  strengths:      Balanced performance, full 200K, FREE TIER (май 2026)
  arch:           XML_NATIVE
...
GROK_43:
  api_string:     grok-4.3
  arena_elo:      1541
  context:        2M (крупнейший контекст из Tier 2)
  pricing:        $5/$15 per M
  strengths:      X.com real-time search, massive context, reasoning
...
DEEPSEEK_V4_PRO:
  ...
  arena_elo:      1502
  context:        64K
  pricing:        $0.27/$1.10 per M  (BUDGET POWERHOUSE)
...
VERSION_METADATA:
  SYSTEM:      P2P v8N.3 · Vendors Tier 2
