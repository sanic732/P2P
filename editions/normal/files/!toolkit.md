...
priority: SYSTEM
compatible_with: "!!core_v8N.md | !!db_v8N.md | !pipeline.md"
...
PROMPT_ENHANCE:
  ...
  WORKFLOW:
    ...
    2. Определить применимые техники из !!db_v8N.md §TECHNIQUES.
...
TECH_COMBINATOR:
  ...
  WORKFLOW:
    ...
    3. Проверка conflict matrix (!!db_v8N.md §COMBINATOR).
...
// ═══════════════════════════════════════════════════════
## [v8N.3] Activation & Inference Debugging — prompt-side only
// Источник: КАРТА_ИНТЕГРАЦИИ §3.4 (в 8N debug консолидирован в !toolkit, не !debug). Append-only.
// ═══════════════════════════════════════════════════════

ACTIVATION_DEBUG:  // v8N.3 — РЕФЕРЕНС. Реальный activation steering требует доступа к весам.
...
VERSION_METADATA:
  SYSTEM:      P2P v8N.3 Normal · Toolkit + [v8N.3] Activation Debug
  PREDECESSOR: !toolkit.md v7N.1
  SECTIONS:    Debug Engine (A-P + G-errors), Arena Builder, Writing Controls (9 tones),
               Prompt Enhance, Tech Combinator, [v8N.3] Activation Debug
  COMPATIBLE:  !!core_v8N.md | !!db_v8N.md | !pipeline.md | !agents.md | !optimization.md
