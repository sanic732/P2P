...
// ─────────────────────────────────────────────────────
// §5. API STRINGS (актуально 2026-05-02)
// ─────────────────────────────────────────────────────

API_STRINGS:

  CLAUDE:
    claude-fable-5                     ← v8N рекомендован (Tier 3-4, #1 Agent/WebDev; Safety Nanny ~5%→Opus 4.8)
    claude-opus-4-8                    ← v8N рекомендован (Tier 3-4, coding #1)
    claude-opus-4-7                    ← legacy флагман (Tier 3-4)
    claude-sonnet-4-6                  ← v8N рекомендован (Tier 1-3)
  ...
  GPT:
    gpt-5.5                            ← Tier 2-4
    gpt-5.5-mini                       ← Tier 0-2
    gpt-5.5-turbo                      ← Tier 1-3
    [PASSED 2026-06-05]: gpt-5.x legacy aliases ретайрнуты → gpt-5.5.

  GEMINI:
    gemini-3.1-pro-latest              ← Tier 2-4, 1M context
    gemini-3.1-flash-latest            ← Tier 0-2, бюджет, high-freq

  GROK:
    grok-4.3                           ← Tier 2-4
    grok-4.3-mini                      ← Tier 0-2
  ...
  QWEN:
    DashScope:   qwen3-max             ← Tier 3-4
    DashScope:   qwen3-plus            ← Tier 1-3
    DashScope:   qwen3-coder-plus      ← Coding optimal
    OpenRouter:  qwen/qwen3-plus       ← Tier 1-3 (G17: prefix required)

  KIMI:
    moonshot-v2-128k                   ← Стандарт
...
VERSION_METADATA:
  SYSTEM:       DB_v8N · P2P v8N.3 Normal Knowledge Base
  PREDECESSOR:  DB_7N (v7N.1)
  CONTENT:      Techniques (38), Errors A-P (16 types), G-errors G1-G20,
