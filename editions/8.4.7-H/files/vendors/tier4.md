...
GLM_52:  // основной GLM — MIT, 1M context (снимает G19-лимит 5.1); WebDev Arena #4
  ...
  ✅ OPENROUTER_GATEWAY_FAIL: ЗАКРЫТО (проверено 8.4.7). PR #27092 влит 08.07 (f2e8d72),
                  issue #26469 закрыт. Прежняя пометка DISPUTED снята — обход больше не нужен.
                  Механика бага для истории:
