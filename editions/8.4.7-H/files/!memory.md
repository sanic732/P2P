...
ADVANCED_MEMORY:  // опционально, активируется при MODULE_RAG/long-session
...
// Мета-фрейминг: !memory / CAPSULE = приём note-taking в CONTEXT ENGINEERING (!compression, раздел «CONTEXT ENGINEERING»).
