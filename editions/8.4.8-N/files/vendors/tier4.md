...
// ═══════════════════════════════════════════════════════
// P2P — VENDORS TIER 4
// Specialist: GLM-5.3 / 5.3-Flash / 5.2 (MIT), Kimi K3 / K2.x (Swarm), Grok 4.20 (Heavy-16, 2M)
...
FILE_META:
  MODELS:      GLM-5.3 / 5.3-Flash / GLM-5.2 (MIT, 1M) / GLM-5.1 (legacy — G19), Kimi K3 / K2.6 / K2.7 Code (Swarm/open-weight)
