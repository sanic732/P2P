# 🟥 P2P 8.4.8-H — High \ Hybrid Edition

> [RU](README.md) · ⬆️ [Back to edition picker](../../README.en.md) · 📖 [Naming guide](../../NAMING.md)

**Version:** 8.4.8-H · **Token budget:** MINIMAL ~60K · STANDARD ~120K (реком.) · FULL ~200K
...
A merge of **8A.1 (Gemini AI Studio) + 8G.1 (Grok)**. Host-gated agents: native **Heavy-16** + **X Firehose** on Grok, simulated QUORUM elsewhere. Host is selected in `_preloader.md`.

## What's new
.3 generation: 6 ON-DEMAND modules, VERSION_COMPAT, dynamic menu, base-model IDs, live specs (2026-06-27). Unifies the former A.1 and G.1 branches.
