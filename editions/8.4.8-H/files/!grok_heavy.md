...
// ═══════════════════════════════════════════════════════
// P2P — GROK HEAVY PACK + STRICT JSON  (grok-native agent generator)
...
FILE_META:
  ...
  API_STRINGS: grok-4.6 (flagship GA 12.08, Grok Build CLI) | grok-4.5 (fallback) | grok-4.20 (2M long-context) | grok-4.3 (1M) ; XML только в code-fences (I6)
