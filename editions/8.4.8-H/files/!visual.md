---
source_id: VISUAL_V8H
version: 8.4.8-H
module_type: on_demand
depends_on: [!!db_v8H.md, !pipeline.md]
...
# !visual.md — Visual / Video / Audio Suite (v8H.3)
...
| 3 | Apply Template I (Image) or Template V (Video) from !pipeline.md |
