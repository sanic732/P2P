...
// ─────────────────────────────────────────────────────
// §2. GROK 4.6 / 4.5 / 4.3  (вендор SpaceXAI, бывш. xAI)
// ─────────────────────────────────────────────────────

GROK_46:  // coding/agentic flagship — GA 2026-08-12 (сменил 4.5; см. live_vendors CAPABILITY_MATRIX)
  api_string:     grok-4.6
  context:        500K
...
GROK_45:  // fallback — GA 2026-07-08 (см. также live_vendors CAPABILITY_MATRIX)
  api_string:     grok-4.5   // ⚠ -heavy / -expert / -fast НЕ СУЩЕСТВУЮТ (единственный id)
  context:        500K | ~80 tps
  ...
  guard:          EU-доступ открыт 21.07, но БЕЗ data-residency → персональные данные EU не пускать;
                  grok-build default
...
DEEPSEEK_V4_PRO:
  ...
  KNOWN_ISSUES:
    ...
    G16: deepseek-chat/reasoner — ИСПОЛНЕНО 2026-07-24 15:59 UTC, без grace-периода.
         ...
         обработчик ошибок должен принимать оба.
...
QWEN_38_MAX:
  ...
  arena_elo:              1685 (WebDev #4)
  context:                1,000,000 | max output 131,072 (max chain-of-thought 262,144)
  pricing:                $2/$6 per M — ПЛОСКИЙ тариф, одна ставка на всё окно (12/36 CNY за 1M);
                          многоуровневая карта $1.20/$6.00 → $2.40/$12.00 → $3.00/$15.00 и потолок 256K ОПРОВЕРГНУТЫ у вендора
