...
MANIFEST:
  SYSTEM:        P2P 8.4.8-H Normal Edition
...
DEADLINES:  // from 2026-09-10
  ...
  ✅ ИСПОЛНЕНО 2026-09-09: промо GLM-5.3-Flash (−50%) истекло — цена $0.15 / $0.03 / $0.50

  [DEADLINE 2026-09-13] 🟡 3 дня — Claude Code: промо +50% к недельным лимитам заканчивается

  [DEADLINE 2026-09-14] 🟡 4 дня — Claude Code: постоянные +25% (Pro/Max/Team/seat Enterprise);
    Anthropic описывает это как −17% против сегодняшнего уровня. [S] Источник — только запись
    29.08 в соцсети; статья help-центра 15910845 в пересказе говорит, что 14.09 лимиты
    «вернутся к стандартным», без +25% — тело статьи не читалось, расхождение не снято

  [DEADLINE 2026-09-20] 🟡 10 дней — GLM-5.3-Flash бесплатен через GLM Coding Plan в ZCode
    (23:00–09:00 UTC+8, с 03.09, все платные планы, без активации) — кампания заканчивается.
    Через агентов кроме ZCode в это же окно доступная квота УДВАИВАЕТСЯ [O docs.z.ai, прочитано 10.09]

  [DEADLINE 2026-09-29] 🟡 19 дней — claude-sonnet-4-5: самая ранняя дата снятия → claude-sonnet-5

  [DEADLINE 2026-10-10] 🟡 30 дней — Alibaba снимает историческую линейку qwen (шесть уведомлений;
    полный список id не прочитан) → линейка 3.8

  [DEADLINE 2026-10-15] 🟡 35 дней — claude-haiku-4-5: самая ранняя дата снятия

  [DEADLINE 2026-10-19] 🟡 39 дней — Microsoft Foundry снимает claude-haiku-4-5 / sonnet-4-5 / opus-4-5

  [DEADLINE 2026-11-21] 🟡 72 дня — GPT-5.6 Sol: промо-цена $4 / $0.40 / $20 держится «не раньше»
    этой даты — это пол, а не жёсткий конец

  [DEADLINE 2026-12-31] 🟡 112 дней — Gemini Flash-линия (3.6/3.7/3.8): вводная цена заканчивается,
...
FRESHNESS:
  ...
  OVERRIDE: LIVE-gist (fetch) > live_vendors.md > vendors/*.md > !!db_v8H.md
