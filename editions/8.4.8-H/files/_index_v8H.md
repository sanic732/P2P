...
MODULE_REGISTRY:
  ...
  HOST-ENGINE (8H — host-choice + Grok advantage):
    ...
    H6. !grok_heavy.md        grok host/target — offer нативного Heavy-16 пака + строгий JSON-контракт (Type H)
...
DEPENDENCY_MAP:
  ...
  !grok_heavy.md    REQUIRES: !host_profiles.md + !agents.md + !tool_budget.md + vendors/grok.md | grok host/target; offer-gated
