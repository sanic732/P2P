...
[![Version](https://img.shields.io/badge/version-v8.4.8-blue)]() [![License](https://img.shields.io/badge/license-MIT-green)]() [![Status](https://img.shields.io/badge/status-BETA-yellow)]() [![Editions](https://img.shields.io/badge/editions-C%20%C2%B7%20H%20%C2%B7%20N%20%C2%B7%20L-orange)]()
...
### ⚡ [Интерактивная карта архитектуры](https://sanic732.github.io/P2P/p2p-map.html)
...
|---|---|---|---|
| 🟦 **[8.4.8-C](editions/8.4.8-C/README.md)** (Claude, внутр. 8C.3) | Работаешь в **Claude** (Code / Cowork / Projects) | только Claude | ~7K |
| 🟥 **[8.4.8-H](editions/8.4.8-H/README.md)** (внутр. 8H.3) | Хочешь максимум / сидишь на **Grok** | 8 хостов (нативно Grok) | ~60K |
| 🟩 **[8.4.8-N](editions/8.4.8-N/README.md)** (внутр. 8N.3) | Твоей модели нет среди «нативных» | любой из 8 | ~60K |
| 🟦 **[8.4.8-L](editions/8.4.8-L/README.md)** (внутр. 8L.3) | Экономия токенов / лимит контекста / **новичкам** | универсальный | **~18K** |
