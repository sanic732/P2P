...
|---|---|---|---|
| 🟦 **[8.4.7-C](editions/8.4.7-C/README.md)** (Claude, внутр. 8C.3) | Работаешь в **Claude** (Code / Cowork / Projects) | только Claude | ~7K |
| 🟥 **[8.4.7-H](editions/8.4.7-H/README.md)** (внутр. 8H.3) | Хочешь максимум / сидишь на **Grok** | 8 хостов (нативно Grok) | ~60K |
| 🟩 **[8.4.7-N](editions/8.4.7-N/README.md)** (внутр. 8N.3) | Твоей модели нет среди «нативных» | любой из 8 | ~60K |
| 🟦 **[8.4.7-L](editions/8.4.7-L/README.md)** (внутр. 8L.3) | Экономия токенов / лимит контекста / **новичкам** | универсальный | **~18K** |
