...
def м_дубль(ф):
    ф[f"editions/{VER}-C/plugin/skills/p2p/SKILL.md"] = (
        "---\nname: p2p\ndescription: \"скилл-дубль\"\n---\n# p2p\n")
...
МУТАЦИИ = [
    ...
    ("имя есть и в commands, и в skills", м_дубль, None,
     r"имя 'p2p' есть и в commands/, и в skills/"),
