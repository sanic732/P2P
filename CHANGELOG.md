...
## [Unreleased · 8.4.6-dev] — 2026-07-26 · Канон версий: одна версия продукта вместо двух систем

> ⏳ **Не закоммичено.** Правки в `editions/8.4.6-{C,H,N,L}`, `.claude-plugin/marketplace.json`,
> `tools/verify_c_dispatch.py`, README. Наружу ничего не публиковалось; гисты Lite не тронуты.
