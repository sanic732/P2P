...
- **Косметический ALPHA→BETA в содержимом** (386 ярлыков `v8C.3-ALPHA`/`v8L.3-ALPHA` в frontmatter/заголовках/бейджах) — **оставлены как на GitHub**. Релиз/маркетплейс и так BETA; ярлыки на работу не влияют.
