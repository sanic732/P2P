...
> ⚠ **УСТАРЕЛО (2026-07-07):** документ описывает состояние до релизов v8.3.5+ и
> **v8.4.1** (опубликован 2026-07-07 05:12, editions/8.4.1-C уже на main). Не использовать
> как источник истины о том, что опубликовано — проверять GitHub (releases / raw plugin.json).
